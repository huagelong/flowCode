> 来源：`docs/plan/07-architecture.md` 第 67 行
> 位置：[总目录](../../README.md) -> [AnserFlow — 系统架构概述](../README.md) -> 二、技术栈总览
> 相邻：[上一篇](../03-目标架构与参考骨架差异清单/README.md) · [下一篇](../05-参考代码映射.md)
> 相关主题：[返回文档入口](../README.md) · [目标架构与参考骨架差异清单](../03-目标架构与参考骨架差异清单/README.md) · [参考代码映射](../05-参考代码映射.md)
