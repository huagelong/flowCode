> 来源：`docs/plan/04b-sandbox-runtime.md` 第 267 行
> 位置：[总目录](../../README.md) -> [AnserFlow - 沙箱执行运行时](../README.md) -> [二、沙箱镜像与执行细节](README.md) -> 运行时数据目录
> 相邻：[上一篇](03-Go-Docker-SDK.md) · [下一篇](../03-三、扩展新运行时指南/README.md)
