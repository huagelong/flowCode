> 来源：`docs/plan/06-agent.md` 第 53 行
> 位置：[总目录](../README.md) -> [AnserFlow - anserAgent 智能体系统](README.md) -> 二、设计基础 — Agent 统一接口
> 相邻：[上一篇](01-一、系统定位.md) · [下一篇](03-三、目录结构.md)
> 相关主题：[返回文档入口](README.md) · [一、系统定位](01-一、系统定位.md) · [三、目录结构](03-三、目录结构.md)
