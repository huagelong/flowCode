> 来源：`docs/plan/06-agent.md` 第 275 行
> 位置：[总目录](../../README.md) -> [AnserFlow - anserAgent 智能体系统](../README.md) -> [五、中断与恢复](README.md) -> 5.3 典型流程
> 相邻：[上一篇](02-5.2-CheckPointStore-接口.md) · [下一篇](../06-六、Human-in-the-Loop/README.md)
