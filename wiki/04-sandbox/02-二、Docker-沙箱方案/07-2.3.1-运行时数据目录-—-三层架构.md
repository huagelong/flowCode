> 来源：`docs/plan/04-sandbox.md` 第 2087 行
> 位置：[总目录](../../README.md) -> [AnserFlow - 沙箱 / Agent 基础设施](../README.md) -> [二、Docker 沙箱方案](README.md) -> 2.3.1 运行时数据目录 — 三层架构
> 相邻：[上一篇](06-2.2.1-数据持久化保障.md) · [下一篇](08-2.4-GitHub-SDK-集成.md)
