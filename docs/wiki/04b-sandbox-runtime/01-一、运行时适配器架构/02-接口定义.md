> 来源：`docs/plan/04b-sandbox-runtime.md` 第 20 行
> 位置：[总目录](../../README.md) -> [AnserFlow - 沙箱执行运行时](../README.md) -> [一、运行时适配器架构](README.md) -> 接口定义
> 相邻：[上一篇](01-设计原则.md) · [下一篇](03-当前实现：anserAgent.md)
