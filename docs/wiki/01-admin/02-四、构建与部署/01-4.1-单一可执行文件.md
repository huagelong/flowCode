> 来源：`docs/plan/01-admin.md` 第 299 行
> 位置：[总目录](../../README.md) -> [AnserFlow - Admin Backend](../README.md) -> [四、构建与部署](README.md) -> 4.1 单一可执行文件
> 相邻：[上一篇](README.md) · [下一篇](02-4.2-Next.js-SPA-模式.md)
