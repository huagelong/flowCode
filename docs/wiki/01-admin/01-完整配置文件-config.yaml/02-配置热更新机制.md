> 来源：`docs/plan/01-admin.md` 第 155 行
> 位置：[总目录](../../README.md) -> [AnserFlow - Admin Backend](../README.md) -> [完整配置文件 (config.yaml)](README.md) -> 配置热更新机制
> 相邻：[上一篇](01-配置归属速查.md) · [下一篇](03-后台管理页面结构.md)
