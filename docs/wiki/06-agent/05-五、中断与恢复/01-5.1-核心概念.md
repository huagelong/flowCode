> 来源：`docs/plan/06-agent.md` 第 225 行
> 位置：[总目录](../../README.md) -> [AnserFlow - anserAgent 智能体系统](../README.md) -> [五、中断与恢复](README.md) -> 5.1 核心概念
> 相邻：[上一篇](README.md) · [下一篇](02-5.2-CheckPointStore-接口.md)
