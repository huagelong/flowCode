> 来源：`docs/plan/02-api.md` 第 929 行
> 位置：[总目录](../../README.md) -> [AnserFlow - API / Backend](../README.md) -> [二、核心数据模型](README.md) -> 2.4 邮件服务
> 相邻：[上一篇](04-2.3-邀请机制说明.md) · [下一篇](06-2.5-API-路由总览.md)
